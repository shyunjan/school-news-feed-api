const RESULT_CODE = (<T extends { [key: string]: number }>(arg: T): T => arg)({
  ...
  AUTH_NEED_NAME: 10220,
  AUTH_NEED_PASSWORD: 10221,
  AUTH_NEED_ADMIN_ID: 10222,
  FAIL_TO_UPDATE_AUTH: 10242,

  /* SCHOOL 관련 에러 - 104XX */
  NOT_FOUND_SCHOOL_IN_SESSION: 10401,
  ALEADY_SCHOOL_EXISTS_IN_SESSION: 10402,

  /* NEWS 관련 에러 - 106XX */
  FAIL_TO_CREATE_NEWS: 10601,
  FAIL_TO_UPDATE_NEWS: 10602,
  FAIL_TO_DELETE_NEWS: 10603,
  ALEADY_DELETED_NEWS: 10604,
  NOT_FOUND_NEWS: 106110,
  UNAUTHORIZED_NEWS: 10611,

  /* SUBSCRIPTION 관련 에러 - 108XX */
  FAIL_TO_DELETE_SUBSCRIPTION: 10803,
  ALEADY_DELETED_SUBSCRIPTION: 10804,
  NOT_FOUND_SUBSCRIPTION: 108110,
